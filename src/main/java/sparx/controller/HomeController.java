...
public class HomeController {
	...
	public String addUser(Model model,@Valid @ModelAttribute("blog") Blog b, BindingResult res, Principal p) {
	...
	public ModelAndView newForum(Model m1) {
		m1.addAttribute("forum", new Forum());
	...
	public String addForum(Model model,@Valid @ModelAttribute("forum") Forum f, BindingResult res, Principal p) {
